...
define('PEANUT_CONNECT_VERSION', '3.7.22');
...
final class Peanut_Connect {
    ...
    private function load_dependencies(): void {
        ...
        // Short-link redirect handler — turns 404 hits on /<slug> into a 302 to Hub's /go/<slug> (v3.7.22+)
        ...
        // the constant has bumped. v3.7.22: previously the schema only
    ...
    private function init_hooks(): void {
        ...
        if ($this->is_hub_connected()) {
            ...
            // response when sync_now=true; v3.7.22: this handler used to live in
     ...
     *
     * v3.7.22: the prior implementation called remove_all_actions('plugins_loaded', 10)
    ...
    public function add_admin_menu(): void {
        ...
        // Legacy options-general.php settings page removed in v3.7.22 — it
 ...
 *
 * v3.7.22: peanut_connect_sync_to_hub was a legacy schedule registered by
...
register_deactivation_hook(__FILE__, function() {
    ...
    // Clear legacy sync cron hook (v3.7.22+: superseded by peanut_connect_hub_sync)
    wp_clear_scheduled_hook('peanut_connect_sync_to_hub');
