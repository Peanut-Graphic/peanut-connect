...
define('PEANUT_CONNECT_VERSION', '3.6.1');
...
final class Peanut_Connect {
    ...
    private function load_dependencies(): void {
        ...
        // ML anomaly detection (v3.6.1+)
        require_once PEANUT_CONNECT_PLUGIN_DIR . 'includes/class-connect-ml-anomaly.php';

        // Marketing proxy (campaign builder, UTMs, links, analytics) for Hub (v3.6.1+)
    ...
    private function init_hooks(): void {
        ...
        // Schedule weekly ML model retraining (v3.6.1+)
...
register_deactivation_hook(__FILE__, function() {
    ...
    // Clear ML training cron job (v3.6.1+)
