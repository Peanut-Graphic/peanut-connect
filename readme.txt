...
= 3.11.2 =
* Security: /restore now verifies archive authenticity (SHA-256 allowlist of backups this site created) before extracting or running any SQL — fixes an authenticated RCE where a leaked Hub bearer could restore a crafted archive and execute its PHP/SQL. Adds zip-slip hardening on restore.
